...
- **EC2**: `i-0d9e31807eb6d9083` (t3.small, ap-northeast-2, Ubuntu 24.04)
- **IP**: 16.184.23.204
- **SSH**: `ssh earnlearning` (~/.ssh/earnlearning.pem)
- **Security Group**: `sg-0a8fe6418029f86d0` (22, 80, 443)
- **Key Pair**: earnlearning

### 도메인 & DNS (Cloudflare)
- **Production**: https://earnlearning.com
- **Staging**: https://stage.earnlearning.com
- **Zone ID**: `1a9714d33dd41eaf2e36d6f369e21239`
...
VAPID_SUBJECT=mailto:cyc@snu.ac.kr
```
